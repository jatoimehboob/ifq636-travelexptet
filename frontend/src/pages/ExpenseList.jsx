...
const ExpenseList = () => {
  ...
  // Fetch Categories (needed to resolve category id -> name)
  ...
  // Resolves a category id to its name. Falls back to the raw value
  // so older records that stored the category name directly still display fine.
